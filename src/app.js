...
client.on("voiceStateUpdate", function(oldMember, newMember){
    ...
    if(newMember.channel == undefined){
        ...
        let myRole = oldMember.guild.roles.cache.find(role => role.name === mute_role);
        newMember.member.roles.remove(myRole)
        //newMember.member.roles.add(newMember.guild.roles.valueOf(role => role.name === "talk"))
        ...
        //oldMember.member.roles.remove(oldMember.guild.roles.valueOf(role => role.name === "talk"))
    }
});
